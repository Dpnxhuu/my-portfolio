  ...
  return (
    <section id="services" className="relative py-20 bg-black overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolte top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-primary/10 opacity-20 rounded-full blur-3xl" />
      </div>

      <div
        className="absolute inset opacity-[0.03]"
        style={{
          backgroundImage: `
        liner-gradient(to right, white 1px, transparent 1px)
