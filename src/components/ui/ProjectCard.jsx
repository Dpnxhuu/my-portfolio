        ...
        <div className="relative h-64 overflow-hidden">
            ...
            <div className="absolute bottom-4 right-4 flex items-center gap-3">
                {demoUrl && (
                    ...
                    className="p-2.5 bg-white/10 backdrop-blur-md rounded-lg border border-white/20 hover:bg-primary30 hover:border-primary/50 transition-all duration-300 hover:scale-110"
                    title="View Demo"
                    >
