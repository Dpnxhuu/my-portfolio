export const projects = [
  {
    ...
    description: 'Full-stack online shopping application with real-time inventory management and secure payments.',
  ...
  
  {
    id: 4,
    title: 'Weather App',
    description: 'Real-time weather forecasting app with location detection using OpenWeather API.',
